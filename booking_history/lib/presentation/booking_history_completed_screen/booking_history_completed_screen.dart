import '../booking_history_completed_screen/widgets/listrectanglesi1_item_widget.dart';
...
class BookingHistoryCompletedScreen extends StatelessWidget {
  @override
                          ...
                          child: Row(
                              ...
                              children: [
                                CustomIconButton(
                                    ...
                                    width: 27,
                                    variant:
                                        IconButtonVariant.FillBluegray1007f,
  ...
  onTapBtnGroupone(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.bookingHistoryCompletedTwoScreen);
  }
}
